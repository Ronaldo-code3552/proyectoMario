...
class PersonaRepository:
    ...
    @staticmethod
    def get_by_id_json(persona_id: int) -> Any:
        with get_connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    @staticmethod
    def update_json(persona_id: int, payload: dict) -> Any:
        with get_connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    @staticmethod
    def delete_json(persona_id: int, force: bool = False) -> Any:
        with get_connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
